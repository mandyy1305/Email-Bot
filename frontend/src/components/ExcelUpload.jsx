      ...
      <div className="mb-10">
        <div className="border-2 border-dashed border-slate-600 rounded-2xl p-12 text-center hover:border-blue-400 transition-all duration-300 bg-slate-700/30">
          ...
          <button
            ...
            className="bg-blue-600 text-white px-8 py-4 rounded-xl font-semibold hover:bg-blue-700 transition-all duration-200 shadow-lg"
          >
            Upload Excel File
          </button>
        ...
        <div className="space-y-8">
          ...
          <div className="text-center">
            <button
              ...
              className="bg-green-600 text-white px-8 py-4 rounded-xl font-semibold hover:bg-green-700 transition-all duration-200 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
            >
